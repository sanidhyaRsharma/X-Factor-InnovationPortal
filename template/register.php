			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="registeruser.php" method="post">

                <div class="form-group">
									<label for="signin-email" class="control-label sr-only">User Name</label>
									<input type="text" class="form-control" name="uname" id="uname" value="" placeholder="username">
								</div>
                ...
                <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" name="pass" id="password" value="" placeholder="Password">
								</div>
                ...
                <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <select class="form-control" id='ustatus' name="status">
                                <option value="2" selected>Internal User </option>
                                <option value="3" >External User</option>
                                <option value="4">Domain Expert</option>
                              </select>
                            </div>
                        </div>


								<button type="submit" id = "submitbtn" name="login" class="btn btn-primary btn-lg btn-block">LOGIN</button>
								<div class="bottom">
